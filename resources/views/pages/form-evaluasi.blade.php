...
@section('content')
    <div class="ml-5 main-content" id="panel" style="overflow-x: hidden">
                                            ...
                                            <optgroup label="{{ $perspektif['number'] }}. {{ $perspektif['perspektif'] }}">
                                                @foreach ($perspektif['ikus'] as $iku)
                                                    <option value="{{ $iku->id }}"
                                                        ...
                                                        data-bobot="{{ $iku->bobot }}" data-satuan="{{ $iku->satuan }}"
                                                        data-base="{{ $iku->base }}">
                                                        {{ $iku->iku }}
                                                    </option>
                                                @endforeach
                            ...
                            <div id="iku-sub-points" style="display: none;">
                                ...
                                <ul id="sub-points-list">
                                    @foreach ($ikuPoints as $formIkuId => $points)
                                        <ul class="sub-points-group" data-iku-id="{{ $formIkuId }}"
                                            style="display: none;">
                                            @foreach ($points as $point)
                                                <li>
                                                    <input type="radio" name="selected_iku_point"
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="percent_year"
                                            id="percent_year">
        ...
        <div class="ml-4 table-responsive" style="overflow-y: hidden;">
